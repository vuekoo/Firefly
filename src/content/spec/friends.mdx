...
export const site = {
  name: "vuekoo博客",
  desc: "授人于鱼，不如授人于渔。.",
  url: "https://vuekoo.com",
  avatar: "https://vuekoo.com/favicon/favicon.ico",
  email: "2710155768@qq.com",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">评论区留言或邮箱申请: 2710155768@qq.com</p>
...
{`站点名称：Vuekoo
站点描述：授人于鱼，不如授人于渔。.
站点链接：https://vuekoo.com/
头像链接：https://vuekoo.com/favicon/favicon.ico`}
              </div>
            </div>
          </div>
